    ...
    return (
        <div className="w-full h-screen bg-slate-200 dark:bg-slate-950 transition-colors duration-300 flex flex-col items-center overflow-hidden">
            ...
            <div className="w-full max-w-7xl h-full flex flex-col gap-5 p-5">
                ...
                <div className="w-full relative rounded-xl shadow-2xl flex-1 flex flex-col bg-white dark:bg-slate-900 z-0 overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-gray-400 scrollbar-track-transparent">
