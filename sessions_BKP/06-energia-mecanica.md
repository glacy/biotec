...
## 6.3 Aceleración centrípeta ($a_\text{c}$)
...
En el laboratorio, no solemos hablar de $a_\text{c}$ en $\text{m/s}^2$, sino de **Fuerza Centrífuga Relativa (FCR o RCF)**, expresada en veces la gravedad ($xg$).
