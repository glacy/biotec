...
El estudio del movimiento puede realizarse *cinemáticamente*, es decir,
especificando la posición, velocidad y y aceleración de un objeto.
También se puede llevar a cabo *dinámicamente* a partir de las causas o
fuerzas que intervienen en el movimiento. Ahora consideraremos el hecho
de que en la vida real, dichos agentes tienen que generar cierto
esfuerzo para poder aplicar dichas fuerzas; de manera que incluiremos un
*análisis energético*.\
...
Considere por ejemplo empujar una caja pesada por una rampa (ver Figura
[1.1](#fig:empujon){reference-type="ref" reference="fig:empujon"}). El
*esfuerzo* que tiene que realizar un agente para mover un objeto depende
tanto de la distancia por la que se aplique la fuerza, como de la
magnitud y dirección de esta.\
Se define el *trabajo* como la *cantidad de energía* que hay que
invertir para cambiar el estado de movimiento de un sistema.\
